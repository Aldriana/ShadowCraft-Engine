...
shoulders = {
    ...
    '(H)Caridean Epaulettes': {'id': 56273, 'agi': 205, 'exp': 150, 'exp': 130, 'sockets': ['red'], 'bonus_stat': 'haste', 'bonus_value': 10},
    'Clandestine Spaulders': {'id': 66905, 'agi': 199, 'crit': 142, 'exp': 116},
    'Embrace of the Night': {'id': 58134, 'agi': 205, 'crit': 150, 'hit': 130, 'sockets': ['blue'], 'bonus_stat': 'agi', 'bonus_value': 10},
    '(H)Thieving Spaulders': {'id': 63449, 'agi': 205, 'crit': 130, 'exp': 150, 'sockets': ['yellow'], 'bonus_stat': 'haste', 'bonus_value': 20},
}
back = {
    ...
    '(H)Cape of the Brotherhood': {'id': 65177, 'agi': 168, 'hit': 112, 'exp': 112},
    ...
    'Softwind Cape': {'id': 62361, 'agi': 168, 'hit': 112, 'exp': 112},
    '(H)Twitching Shadows': {'id': 56315, 'agi': 168, 'crit': 112, 'exp': 112},
}
chest = {
    ...
    '(H)Sark of the Unwatched': {'id': 65060, 'agi': 345, 'crit': 227, 'exp': 247,'sockets': ['red', 'yellow'], 'bonus_stat': 'mastery', 'bonus_value': 20},
    ...
    '(H)Defias Brotherhood Vest': {'id': 63468, 'agi': 262, 'exp': 182, 'mastery': 182, 'sockets': ['red', 'yellow'], 'bonus_stat': 'mastery', 'bonus_value': 20},
    '(H)Hieroglyphic Vest': {'id': 57874, 'agi': 262, 'crit': 182, 'exp': 182, 'sockets': ['yellow', 'yellow'], 'bonus_stat': 'agi', 'bonus_value': 20},
    'Hieroglyphic Vest': {'id': 57863, 'agi': 228, 'crit': 158, 'exp': 158, 'sockets': ['yellow', 'yellow'], 'bonus_stat': 'agi', 'bonus_value': 20},
    ...
    'Vest of Misshapen Hides': {'id': 56123, 'agi': 268, 'crit': 178, 'mastery': 178},
...
wrists = {
    ...
    '(H)Poison Fang Bracers': {'id': 56409, 'agi': 168, 'hit': 112, 'exp': 112},
    'Poison Fang Bracers': {'id': 55886, 'agi': 149, 'hit': 100, 'exp': 100},
}
hands = {
    ...
    "Liar's Handwraps": {'id': 62417, 'agi': 233, 'crit': 149, 'exp': 169, 'sockets': ['yellow'], 'bonus_stat': 'haste', 'bonus_value': 10},
    'Stormbolt Gloves': {'id': 62433, 'agi': 233, 'crit': 149, 'exp': 169, 'sockets': ['yellow'], 'bonus_stat': 'haste', 'bonus_value': 10},
    ...
    'Sticky Fingers': {'id': 58138, 'agi': 205, 'exp': 130, 'mastery': 150, 'sockets': ['yellow'], 'bonus_stat': 'agi', 'bonus_value': 10},
}
waist = {
    ...
    'Dispersing Belt': {'id': 59502, 'agi': 233, 'crit': 149, 'exp': 169, 'sockets': ['blue', 'prismatic'], 'bonus_stat': 'agi', 'bonus_value': 10},
    'Belt of a Thousand Mouths': {'id': 67240, 'agi': 225, 'crit': 150, 'exp': 150, 'sockets': ['prismatic']},
    'Quicksand Belt': {'id': 62446, 'agi': 205, 'crit': 130, 'hit': 150, 'sockets': ['blue', 'prismatic'], 'bonus_stat': 'agi', 'bonus_value': 10},
    '(H)Red Beam Cord': {'id': 56429, 'agi': 205, 'crit': 130, 'exp': 150, 'sockets': ['blue', 'prismatic'], 'bonus_stat': 'haste', 'bonus_value': 10},
    'Red Beam Cord': {'id': 56098, 'agi': 199, 'crit': 133, 'exp': 133, 'sockets': ['blue', 'prismatic'], 'bonus_stat': 'haste', 'bonus_value': 10},
    'Sash of Musing': {'id': 57918, 'agi': 205, 'exp': 130, 'mastery': 150, 'sockets': ['red', 'prismatic'], 'bonus_stat': 'mastery', 'bonus_value': 10},
}
legs = {
    "(H)Aberration's Leggings": {'id': 65039, 'agi': 345, 'crit': 257, 'exp': 217, 'sockets': ['yellow', 'yellow'], 'bonus_stat': 'agi', 'bonus_value': 20},
    "Aberration's Leggings": {'id': 59343, 'agi': 301, 'crit': 228, 'exp': 188, 'sockets': ['yellow', 'yellow'], 'bonus_stat': 'agi', 'bonus_value': 20},
    ...
    "(H)Beauty's Chew Toy": {'id': 56309, 'agi': 262, 'hit': 162, 'exp': 202, 'sockets': ['red', 'blue'], 'bonus_stat': 'haste', 'bonus_value': 20},
    ...
    'Leggings of the Impenitent': {'id': 62405, 'agi': 228, 'crit': 168, 'exp': 148, 'sockets': ['red', 'yellow'], 'bonus_stat': 'crit', 'bonus_value': 20},
    "Shaw's Finest Leggings": {'id': 63707, 'agi': 268, 'crit': 191, 'exp': 157},
    'Swiftflight Leggings': {'id': 62425, 'agi': 228, 'crit': 168, 'exp': 148, 'sockets': ['red', 'yellow'], 'bonus_stat': 'crit', 'bonus_value': 20},
}
feet = {
    ...
    "Storm Rider's Boots": {'id': 59469, 'agi': 233, 'exp': 149, 'mastery': 169, 'sockets': ['yellow'], 'bonus_stat': 'mastery', 'bonus_value': 10},
    'Treads of Fleeting Joy': {'id': 58482, 'agi': 233, 'crit': 149, 'exp': 169, 'sockets': ['blue'], 'bonus_stat': 'agi', 'bonus_value': 10},
    'Boots of the Hard Way': {'id': 66914, 'agi': 199, 'crit': 116, 'exp': 142},
    '(H)Boots of the Predator': {'id': 63435, 'agi': 205, 'crit': 150, 'hit': 130, 'sockets': ['yellow'], 'bonus_stat': 'crit', 'bonus_value': 10},
    "(H)Crafty's Gaiters": {'id': 56395, 'agi': 205, 'exp': 130, 'mastery': 150, 'sockets': ['blue'], 'bonus_stat': 'mastery', 'bonus_value': 10},
    "Crafty's Gaiters": {'id': 55871, 'agi': 199, 'exp': 133, 'mastery': 133},
    "(H)VanCleef's Boots": {'id': 65178, 'agi': 205, 'exp': 150, 'mastery': 130, 'sockets': ['yellow'], 'bonus_stat': 'agi', 'bonus_value': 10},
}
rings = {
    'Gilnean Ring of Ruination': {'id': 67136, 'agi': 190, 'hit': 108, 'exp': 138},
    ...
    '(H)Mirage Ring': {'id': 56404, 'agi': 168, 'hit': 85, 'exp': 128},
    'Mirage Ring': {'id': 55884, 'agi': 149, 'hit': 76, 'exp': 114},
    '(H)Nautilus Ring': {'id': 56282, 'agi': 168, 'crit': 112, 'exp': 112},
    '(H)Ring of Blinding Stars': {'id': 56412, 'agi': 168, 'exp': 112, 'mastery': 112},
    'Ring of Blinding Stars': {'id': 55994, 'agi': 149, 'exp': 100, 'mastery': 100},
...
melee_weapons = {
    ...
    '1.4d (H)Buzzer Blade': {'id': 65163, 'agi': 129, 'crit': 86, 'exp': 86, 'damage': 573.5, 'speed': 1.4, 'type': 'dagger'},
    '1.8d Dagger of Restless Nights': {'id': 62456, 'agi': 129, 'crit': 86, 'hit': 86, 'damage': 737, 'speed': 1.8, 'type': 'dagger'},
    '1.8d Elementium Shank': {'id': 55068, 'agi': 129, 'hit': 86, 'exp': 86, 'damage': 737.5, 'speed': 1.8, 'type': 'dagger'},
    ...
    '1.4d (H)Quicksilver Blade': {'id': 56335, 'agi': 129, 'exp': 86, 'mastery': 86, 'damage': 573.5, 'speed': 1.4, 'type': 'dagger'},
    ...
    '2.6f (H)Claws of Torment': {'id': 65006, 'agi': 165, 'crit': 110, 'exp': 110, 'damage': 1356.5, 'speed': 2.6, 'type': 'fist'}, # main hand
    '2.6f Claws of Torment': {'id': 63537, 'agi': 146, 'crit': 97, 'exp': 97, 'damage': 1202, 'speed': 2.6, 'type': 'fist'}, # main hand
    '2.6f Crystalline Geoknife': {'id': 66972, 'agi': 115, 'crit': 76, 'exp': 76, 'damage': 943.5, 'speed': 2.6, 'type': 'fist'}, # main hand
    '2.6f (H)Fist of Pained Senses': {'id': 56329, 'agi': 129, 'crit': 86, 'exp': 86, 'damage': 1065, 'speed': 2.6, 'type': 'fist'}, # main hand
    ...
    "2.6a (H)Crul'korak, the Lightning's Arc": {'id': 65024, 'agi': 165, 'crit': 110, 'exp': 110, 'damage': 1356.5, 'speed': 2.6, 'type': 'axe'},
    "2.6a Crul'korak, the Lightning's Arc": {'id': 59443, 'agi': 146, 'crit': 97, 'exp': 97, 'damage': 1202, 'speed': 2.6, 'type': 'axe'},
    ...
    "2.6a Calder's Coated Carrion Carver": {'id': 63788, 'agi': 115, 'crit': 84, 'exp': 63, 'damage': 943.5, 'speed': 2.6, 'type': 'axe'},
    ...
    '2.6a Ravening Slicer': {'id': 62457, 'agi': 129, 'exp': 86, 'mastery': 86, 'damage': 1065, 'speed': 2.6, 'type': 'axe'},
    ...
    '2.6s Krol Decapitator': {'id': 68161, 'agi': 146, 'hit': 86, 'exp': 105, 'damage': 1202, 'speed': 2.6, 'type': 'sword'},
    '2.7s (H)Cruel Barb': {'id': 65164, 'agi': 129, 'crit': 86, 'hit': 86, 'damage': 1106, 'speed': 2.7, 'type': 'sword'},
    "2.6s (H)Thief's Blade": {'id': 65173, 'agi': 129, 'exp': 86, 'mastery': 86, 'damage': 1065, 'speed': 2.6, 'type': 'sword'},
}
