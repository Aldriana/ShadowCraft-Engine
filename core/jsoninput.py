...
if __name__ == '__main__':
    json_string = json.dumps({"race": "night_elf",
        "level": 85,
        "settings": {
            "type": "assassination", "response_time": 1,
        },
        "stats": {
             "str": 20, "agi": 4756, "ap": 190, "crit": 1022, "hit": 1329, "exp": 159, "haste": 1291, "mastery": 1713,
             "mh" : { "damage": 939.5, "speed": 1.8, "type": "dagger", "enchant": "landslide" },
             "oh" : { "damage": 730.5, "speed": 1.4, "type": "dagger", "enchant": "landslide" },
             "ranged": {"damage": 1371.5, "speed": 2.2, "type": "thrown"},
             "procs": ["heroic_prestors_talisman_of_machination", "fluid_death", "rogue_t11_4pc"],
             "gear_buffs": ["rogue_t11_2pc" , "leather_specialization", "potion_of_the_tolvir", "chaotic_metagem"],
        },
        "glyphs": ["backstab", "mutilate", "rupture"],
        "buffs": ["short_term_haste_buff",
        ...
        "agi_flask",
        "guild_feast"],
        "talents": ["0333230113022110321", "0020000000000000000", "2030030000000000000"],
    })
