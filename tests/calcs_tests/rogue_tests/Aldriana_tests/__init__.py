...
class TestAldrianasRogueDamageCalculator(unittest.TestCase):
    def test_get_ep(self):
        ...
        self.assertLess(ep_values['agi'], 4.0)
        self.assertGreater(ep_values['agi'], 2.0)
        self.assertLess(ep_values['yellow_hit'], 4.0)
        self.assertGreater(ep_values['yellow_hit'], 1.0)
        self.assertLess(ep_values['crit'], 2.0)
        self.assertGreater(ep_values['crit'], 0.0)
